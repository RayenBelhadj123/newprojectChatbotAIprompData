...
In the reproducible evaluation generated from the included CSV file, Linear Regression produced the strongest chronological test performance because the dataset contains lagged and smoothed housing-price features that preserve the main trend.
Ridge Regression remained useful as a stable interpretable baseline, while tree-based models provided diagnostic insight into the limits of extrapolating later high-price periods.
