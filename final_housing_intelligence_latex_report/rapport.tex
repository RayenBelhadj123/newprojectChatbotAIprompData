...
The generated chronological evaluation also showed that the best model can depend strongly on the selected feature set: with lagged and smoothed price indicators included, Linear Regression delivered the strongest test performance, while Ridge Regression and tree-based models remained valuable for interpretation and diagnostic comparison.
